...
// Module
exports.push([module.i, "@charset \"UTF-8\";\n/* http://meyerweb.com/eric/tools/css/reset/\n   v4.0 | 20180602\n   License: none (public domain)\n*/\nhtml, body, div, span, applet, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\na, abbr, acronym, address, big, cite, code,\ndel, dfn, em, img, ins, kbd, q, s, samp,\nsmall, strike, strong, sub, sup, tt, var,\nb, u, i, center,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td,\narticle, aside, canvas, details, embed,\nfigure, figcaption, footer, header, hgroup,\nmain, menu, nav, output, ruby, section, summary,\ntime, mark, audio, video {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  font-size: 100%;\n  font: inherit;\n  vertical-align: baseline; }\n\n/* HTML5 display-role reset for older browsers */\narticle, aside, details, figcaption, figure,\nfooter, header, hgroup, main, menu, nav, section {\n  display: block; }\n\n/* HTML5 hidden-attribute fix for newer browsers */\n*[hidden] {\n  display: none; }\n\nbody {\n  line-height: 1; }\n\nol, ul {\n  list-style: none; }\n\nblockquote, q {\n  quotes: none; }\n\nblockquote:before, blockquote:after,\nq:before, q:after {\n  content: '';\n  content: none; }\n\ntable {\n  border-collapse: collapse;\n  border-spacing: 0; }\n\n* {\n  box-sizing: border-box; }\n\nhtml,\nbody {\n  height: 100%;\n  overflow: hidden; }\n\nbody {\n  background: #60B28F;\n  display: flex;\n  flex-direction: row; }\n\n@media screen and (max-aspect-ratio: 1 / 1) {\n  body {\n    flex-direction: column; } }\n\n.grid {\n  flex: 1 1 75%;\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap; }\n\n.row {\n  width: 100%;\n  display: flex;\n  flex-direction: row;\n  flex-wrap: nowrap;\n  overflow: hidden; }\n  .row:first-child {\n    height: 60.52632%; }\n  .row:last-child {\n    height: 39.47368%; }\n\n.cell {\n  flex-grow: 1;\n  flex-shrink: 1;\n  flex-basis: 11%;\n  position: relative;\n  margin: 0 5px;\n  -webkit-animation-duration: 5s;\n          animation-duration: 5s;\n  -webkit-animation-timing-function: linear;\n          animation-timing-function: linear;\n  -webkit-animation-iteration-count: infinite;\n          animation-iteration-count: infinite; }\n\n.cell--n {\n  margin-right: 25px; }\n\n.cell--f {\n  margin-left: 25px; }\n\n.letter {\n  position: absolute;\n  left: 0;\n  width: 100%; }\n  .row:first-child .letter {\n    -webkit-transform-origin: top;\n            transform-origin: top;\n    top: 0; }\n  .row:last-child .letter {\n    -webkit-transform-origin: bottom;\n            transform-origin: bottom;\n    bottom: 0; }\n\n.row .cell {\n  -webkit-animation-duration: 20s;\n          animation-duration: 20s;\n  -webkit-animation-iteration-count: infinite;\n          animation-iteration-count: infinite; }\n\n.row:first-child .cell {\n  -webkit-animation-name: squishTop;\n          animation-name: squishTop;\n  -webkit-transform-origin: bottom left;\n          transform-origin: bottom left; }\n\n.row:last-child .cell {\n  -webkit-animation-name: squishBottom;\n          animation-name: squishBottom;\n  -webkit-transform-origin: top left;\n          transform-origin: top left; }\n\n.letter svg path {\n  fill: #F5BF41;\n  stroke: #6EF17E;\n  stroke-width: 1px; }\n\n.row:first-child .cell:nth-child(1) {\n  -webkit-animation-delay: 0.5s;\n          animation-delay: 0.5s; }\n\n.row:last-child .cell:nth-child(1) {\n  -webkit-animation-delay: 0.5s;\n          animation-delay: 0.5s; }\n\n.row:first-child .cell:nth-child(2) {\n  -webkit-animation-delay: 1s;\n          animation-delay: 1s; }\n\n.row:last-child .cell:nth-child(2) {\n  -webkit-animation-delay: 1s;\n          animation-delay: 1s; }\n\n.row:first-child .cell:nth-child(3) {\n  -webkit-animation-delay: 1.5s;\n          animation-delay: 1.5s; }\n\n.row:last-child .cell:nth-child(3) {\n  -webkit-animation-delay: 1.5s;\n          animation-delay: 1.5s; }\n\n.row:first-child .cell:nth-child(4) {\n  -webkit-animation-delay: 2s;\n          animation-delay: 2s; }\n\n.row:last-child .cell:nth-child(4) {\n  -webkit-animation-delay: 2s;\n          animation-delay: 2s; }\n\n.row:first-child .cell:nth-child(5) {\n  -webkit-animation-delay: 2.5s;\n          animation-delay: 2.5s; }\n\n.row:last-child .cell:nth-child(5) {\n  -webkit-animation-delay: 2.5s;\n          animation-delay: 2.5s; }\n\n.row:first-child .cell:nth-child(6) {\n  -webkit-animation-delay: 3s;\n          animation-delay: 3s; }\n\n.row:last-child .cell:nth-child(6) {\n  -webkit-animation-delay: 3s;\n          animation-delay: 3s; }\n\n.row:first-child .cell:nth-child(7) {\n  -webkit-animation-delay: 3.5s;\n          animation-delay: 3.5s; }\n\n.row:last-child .cell:nth-child(7) {\n  -webkit-animation-delay: 3.5s;\n          animation-delay: 3.5s; }\n\n.row:first-child .cell:nth-child(8) {\n  -webkit-animation-delay: 4s;\n          animation-delay: 4s; }\n\n.row:last-child .cell:nth-child(8) {\n  -webkit-animation-delay: 4s;\n          animation-delay: 4s; }\n\n.row:first-child .cell:nth-child(9) {\n  -webkit-animation-delay: 4.5s;\n          animation-delay: 4.5s; }\n\n.row:last-child .cell:nth-child(9) {\n  -webkit-animation-delay: 4.5s;\n          animation-delay: 4.5s; }\n\n@-webkit-keyframes squishTop {\n  /* from π thru 2π */\n  1% {\n    -webkit-transform: scaleY(0.93947);\n            transform: scaleY(0.93947); }\n  2% {\n    -webkit-transform: scaleY(0.88313);\n            transform: scaleY(0.88313); }\n  3% {\n    -webkit-transform: scaleY(0.82725);\n            transform: scaleY(0.82725); }\n  4% {\n    -webkit-transform: scaleY(0.77205);\n            transform: scaleY(0.77205); }\n  5% {\n    -webkit-transform: scaleY(0.71776);\n            transform: scaleY(0.71776); }\n  6% {\n    -webkit-transform: scaleY(0.66458);\n            transform: scaleY(0.66458); }\n  7% {\n    -webkit-transform: scaleY(0.61273);\n            transform: scaleY(0.61273); }\n  8% {\n    -webkit-transform: scaleY(0.56241);\n            transform: scaleY(0.56241); }\n  9% {\n    -webkit-transform: scaleY(0.51383);\n            transform: scaleY(0.51383); }\n  10% {\n    -webkit-transform: scaleY(0.46717);\n            transform: scaleY(0.46717); }\n  11% {\n    -webkit-transform: scaleY(0.42261);\n            transform: scaleY(0.42261); }\n  12% {\n    -webkit-transform: scaleY(0.38035);\n            transform: scaleY(0.38035); }\n  13% {\n    -webkit-transform: scaleY(0.34053);\n            transform: scaleY(0.34053); }\n  14% {\n    -webkit-transform: scaleY(0.30333);\n            transform: scaleY(0.30333); }\n  15% {\n    -webkit-transform: scaleY(0.26888);\n            transform: scaleY(0.26888); }\n  16% {\n    -webkit-transform: scaleY(0.23732);\n            transform: scaleY(0.23732); }\n  17% {\n    -webkit-transform: scaleY(0.20879);\n            transform: scaleY(0.20879); }\n  18% {\n    -webkit-transform: scaleY(0.18338);\n            transform: scaleY(0.18338); }\n  19% {\n    -webkit-transform: scaleY(0.16121);\n            transform: scaleY(0.16121); }\n  20% {\n    -webkit-transform: scaleY(0.14236);\n            transform: scaleY(0.14236); }\n  21% {\n    -webkit-transform: scaleY(0.1269);\n            transform: scaleY(0.1269); }\n  22% {\n    -webkit-transform: scaleY(0.11489);\n            transform: scaleY(0.11489); }\n  23% {\n    -webkit-transform: scaleY(0.10639);\n            transform: scaleY(0.10639); }\n  24% {\n    -webkit-transform: scaleY(0.10143);\n            transform: scaleY(0.10143); }\n  25% {\n    -webkit-transform: scaleY(0.10002);\n            transform: scaleY(0.10002); }\n  26% {\n    -webkit-transform: scaleY(0.10217);\n            transform: scaleY(0.10217); }\n  27% {\n    -webkit-transform: scaleY(0.10788);\n            transform: scaleY(0.10788); }\n  28% {\n    -webkit-transform: scaleY(0.11712);\n            transform: scaleY(0.11712); }\n  29% {\n    -webkit-transform: scaleY(0.12985);\n            transform: scaleY(0.12985); }\n  30% {\n    -webkit-transform: scaleY(0.14602);\n            transform: scaleY(0.14602); }\n  31% {\n    -webkit-transform: scaleY(0.16558);\n            transform: scaleY(0.16558); }\n  32% {\n    -webkit-transform: scaleY(0.18843);\n            transform: scaleY(0.18843); }\n  33% {\n    -webkit-transform: scaleY(0.2145);\n            transform: scaleY(0.2145); }\n  34% {\n    -webkit-transform: scaleY(0.24368);\n            transform: scaleY(0.24368); }\n  35% {\n    -webkit-transform: scaleY(0.27585);\n            transform: scaleY(0.27585); }\n  36% {\n    -webkit-transform: scaleY(0.31089);\n            transform: scaleY(0.31089); }\n  37% {\n    -webkit-transform: scaleY(0.34865);\n            transform: scaleY(0.34865); }\n  38% {\n    -webkit-transform: scaleY(0.38899);\n            transform: scaleY(0.38899); }\n  39% {\n    -webkit-transform: scaleY(0.43175);\n            transform: scaleY(0.43175); }\n  40% {\n    -webkit-transform: scaleY(0.47676);\n            transform: scaleY(0.47676); }\n  41% {\n    -webkit-transform: scaleY(0.52384);\n            transform: scaleY(0.52384); }\n  42% {\n    -webkit-transform: scaleY(0.5728);\n            transform: scaleY(0.5728); }\n  43% {\n    -webkit-transform: scaleY(0.62346);\n            transform: scaleY(0.62346); }\n  44% {\n    -webkit-transform: scaleY(0.6756);\n            transform: scaleY(0.6756); }\n  45% {\n    -webkit-transform: scaleY(0.72903);\n            transform: scaleY(0.72903); }\n  46% {\n    -webkit-transform: scaleY(0.78353);\n            transform: scaleY(0.78353); }\n  47% {\n    -webkit-transform: scaleY(0.83889);\n            transform: scaleY(0.83889); }\n  48% {\n    -webkit-transform: scaleY(0.89488);\n            transform: scaleY(0.89488); }\n  49% {\n    -webkit-transform: scaleY(0.95129);\n            transform: scaleY(0.95129); }\n  50% {\n    -webkit-transform: scaleY(1.0079);\n            transform: scaleY(1.0079); }\n  100% {\n    -webkit-transform: scaleY(1);\n            transform: scaleY(1); } }\n\n@keyframes squishTop {\n  /* from π thru 2π */\n  1% {\n    -webkit-transform: scaleY(0.93947);\n            transform: scaleY(0.93947); }\n  2% {\n    -webkit-transform: scaleY(0.88313);\n            transform: scaleY(0.88313); }\n  3% {\n    -webkit-transform: scaleY(0.82725);\n            transform: scaleY(0.82725); }\n  4% {\n    -webkit-transform: scaleY(0.77205);\n            transform: scaleY(0.77205); }\n  5% {\n    -webkit-transform: scaleY(0.71776);\n            transform: scaleY(0.71776); }\n  6% {\n    -webkit-transform: scaleY(0.66458);\n            transform: scaleY(0.66458); }\n  7% {\n    -webkit-transform: scaleY(0.61273);\n            transform: scaleY(0.61273); }\n  8% {\n    -webkit-transform: scaleY(0.56241);\n            transform: scaleY(0.56241); }\n  9% {\n    -webkit-transform: scaleY(0.51383);\n            transform: scaleY(0.51383); }\n  10% {\n    -webkit-transform: scaleY(0.46717);\n            transform: scaleY(0.46717); }\n  11% {\n    -webkit-transform: scaleY(0.42261);\n            transform: scaleY(0.42261); }\n  12% {\n    -webkit-transform: scaleY(0.38035);\n            transform: scaleY(0.38035); }\n  13% {\n    -webkit-transform: scaleY(0.34053);\n            transform: scaleY(0.34053); }\n  14% {\n    -webkit-transform: scaleY(0.30333);\n            transform: scaleY(0.30333); }\n  15% {\n    -webkit-transform: scaleY(0.26888);\n            transform: scaleY(0.26888); }\n  16% {\n    -webkit-transform: scaleY(0.23732);\n            transform: scaleY(0.23732); }\n  17% {\n    -webkit-transform: scaleY(0.20879);\n            transform: scaleY(0.20879); }\n  18% {\n    -webkit-transform: scaleY(0.18338);\n            transform: scaleY(0.18338); }\n  19% {\n    -webkit-transform: scaleY(0.16121);\n            transform: scaleY(0.16121); }\n  20% {\n    -webkit-transform: scaleY(0.14236);\n            transform: scaleY(0.14236); }\n  21% {\n    -webkit-transform: scaleY(0.1269);\n            transform: scaleY(0.1269); }\n  22% {\n    -webkit-transform: scaleY(0.11489);\n            transform: scaleY(0.11489); }\n  23% {\n    -webkit-transform: scaleY(0.10639);\n            transform: scaleY(0.10639); }\n  24% {\n    -webkit-transform: scaleY(0.10143);\n            transform: scaleY(0.10143); }\n  25% {\n    -webkit-transform: scaleY(0.10002);\n            transform: scaleY(0.10002); }\n  26% {\n    -webkit-transform: scaleY(0.10217);\n            transform: scaleY(0.10217); }\n  27% {\n    -webkit-transform: scaleY(0.10788);\n            transform: scaleY(0.10788); }\n  28% {\n    -webkit-transform: scaleY(0.11712);\n            transform: scaleY(0.11712); }\n  29% {\n    -webkit-transform: scaleY(0.12985);\n            transform: scaleY(0.12985); }\n  30% {\n    -webkit-transform: scaleY(0.14602);\n            transform: scaleY(0.14602); }\n  31% {\n    -webkit-transform: scaleY(0.16558);\n            transform: scaleY(0.16558); }\n  32% {\n    -webkit-transform: scaleY(0.18843);\n            transform: scaleY(0.18843); }\n  33% {\n    -webkit-transform: scaleY(0.2145);\n            transform: scaleY(0.2145); }\n  34% {\n    -webkit-transform: scaleY(0.24368);\n            transform: scaleY(0.24368); }\n  35% {\n    -webkit-transform: scaleY(0.27585);\n            transform: scaleY(0.27585); }\n  36% {\n    -webkit-transform: scaleY(0.31089);\n            transform: scaleY(0.31089); }\n  37% {\n    -webkit-transform: scaleY(0.34865);\n            transform: scaleY(0.34865); }\n  38% {\n    -webkit-transform: scaleY(0.38899);\n            transform: scaleY(0.38899); }\n  39% {\n    -webkit-transform: scaleY(0.43175);\n            transform: scaleY(0.43175); }\n  40% {\n    -webkit-transform: scaleY(0.47676);\n            transform: scaleY(0.47676); }\n  41% {\n    -webkit-transform: scaleY(0.52384);\n            transform: scaleY(0.52384); }\n  42% {\n    -webkit-transform: scaleY(0.5728);\n            transform: scaleY(0.5728); }\n  43% {\n    -webkit-transform: scaleY(0.62346);\n            transform: scaleY(0.62346); }\n  44% {\n    -webkit-transform: scaleY(0.6756);\n            transform: scaleY(0.6756); }\n  45% {\n    -webkit-transform: scaleY(0.72903);\n            transform: scaleY(0.72903); }\n  46% {\n    -webkit-transform: scaleY(0.78353);\n            transform: scaleY(0.78353); }\n  47% {\n    -webkit-transform: scaleY(0.83889);\n            transform: scaleY(0.83889); }\n  48% {\n    -webkit-transform: scaleY(0.89488);\n            transform: scaleY(0.89488); }\n  49% {\n    -webkit-transform: scaleY(0.95129);\n            transform: scaleY(0.95129); }\n  50% {\n    -webkit-transform: scaleY(1.0079);\n            transform: scaleY(1.0079); }\n  100% {\n    -webkit-transform: scaleY(1);\n            transform: scaleY(1); } }\n\n@-webkit-keyframes squishBottom {\n  0% {\n    -webkit-transform: scaleY(1);\n            transform: scaleY(1); }\n  50% {\n    -webkit-transform: scaleY(1);\n            transform: scaleY(1); }\n  /* from π thru 2π */\n  51% {\n    -webkit-transform: scaleY(0.93947);\n            transform: scaleY(0.93947); }\n  52% {\n    -webkit-transform: scaleY(0.88313);\n            transform: scaleY(0.88313); }\n  53% {\n    -webkit-transform: scaleY(0.82725);\n            transform: scaleY(0.82725); }\n  54% {\n    -webkit-transform: scaleY(0.77205);\n            transform: scaleY(0.77205); }\n  55% {\n    -webkit-transform: scaleY(0.71776);\n            transform: scaleY(0.71776); }\n  56% {\n    -webkit-transform: scaleY(0.66458);\n            transform: scaleY(0.66458); }\n  57% {\n    -webkit-transform: scaleY(0.61273);\n            transform: scaleY(0.61273); }\n  58% {\n    -webkit-transform: scaleY(0.56241);\n            transform: scaleY(0.56241); }\n  59% {\n    -webkit-transform: scaleY(0.51383);\n            transform: scaleY(0.51383); }\n  60% {\n    -webkit-transform: scaleY(0.46717);\n            transform: scaleY(0.46717); }\n  61% {\n    -webkit-transform: scaleY(0.42261);\n            transform: scaleY(0.42261); }\n  62% {\n    -webkit-transform: scaleY(0.38035);\n            transform: scaleY(0.38035); }\n  63% {\n    -webkit-transform: scaleY(0.34053);\n            transform: scaleY(0.34053); }\n  64% {\n    -webkit-transform: scaleY(0.30333);\n            transform: scaleY(0.30333); }\n  65% {\n    -webkit-transform: scaleY(0.26888);\n            transform: scaleY(0.26888); }\n  66% {\n    -webkit-transform: scaleY(0.23732);\n            transform: scaleY(0.23732); }\n  67% {\n    -webkit-transform: scaleY(0.20879);\n            transform: scaleY(0.20879); }\n  68% {\n    -webkit-transform: scaleY(0.18338);\n            transform: scaleY(0.18338); }\n  69% {\n    -webkit-transform: scaleY(0.16121);\n            transform: scaleY(0.16121); }\n  70% {\n    -webkit-transform: scaleY(0.14236);\n            transform: scaleY(0.14236); }\n  71% {\n    -webkit-transform: scaleY(0.1269);\n            transform: scaleY(0.1269); }\n  72% {\n    -webkit-transform: scaleY(0.11489);\n            transform: scaleY(0.11489); }\n  73% {\n    -webkit-transform: scaleY(0.10639);\n            transform: scaleY(0.10639); }\n  74% {\n    -webkit-transform: scaleY(0.10143);\n            transform: scaleY(0.10143); }\n  75% {\n    -webkit-transform: scaleY(0.10002);\n            transform: scaleY(0.10002); }\n  76% {\n    -webkit-transform: scaleY(0.10217);\n            transform: scaleY(0.10217); }\n  77% {\n    -webkit-transform: scaleY(0.10788);\n            transform: scaleY(0.10788); }\n  78% {\n    -webkit-transform: scaleY(0.11712);\n            transform: scaleY(0.11712); }\n  79% {\n    -webkit-transform: scaleY(0.12985);\n            transform: scaleY(0.12985); }\n  80% {\n    -webkit-transform: scaleY(0.14602);\n            transform: scaleY(0.14602); }\n  81% {\n    -webkit-transform: scaleY(0.16558);\n            transform: scaleY(0.16558); }\n  82% {\n    -webkit-transform: scaleY(0.18843);\n            transform: scaleY(0.18843); }\n  83% {\n    -webkit-transform: scaleY(0.2145);\n            transform: scaleY(0.2145); }\n  84% {\n    -webkit-transform: scaleY(0.24368);\n            transform: scaleY(0.24368); }\n  85% {\n    -webkit-transform: scaleY(0.27585);\n            transform: scaleY(0.27585); }\n  86% {\n    -webkit-transform: scaleY(0.31089);\n            transform: scaleY(0.31089); }\n  87% {\n    -webkit-transform: scaleY(0.34865);\n            transform: scaleY(0.34865); }\n  88% {\n    -webkit-transform: scaleY(0.38899);\n            transform: scaleY(0.38899); }\n  89% {\n    -webkit-transform: scaleY(0.43175);\n            transform: scaleY(0.43175); }\n  90% {\n    -webkit-transform: scaleY(0.47676);\n            transform: scaleY(0.47676); }\n  91% {\n    -webkit-transform: scaleY(0.52384);\n            transform: scaleY(0.52384); }\n  92% {\n    -webkit-transform: scaleY(0.5728);\n            transform: scaleY(0.5728); }\n  93% {\n    -webkit-transform: scaleY(0.62346);\n            transform: scaleY(0.62346); }\n  94% {\n    -webkit-transform: scaleY(0.6756);\n            transform: scaleY(0.6756); }\n  95% {\n    -webkit-transform: scaleY(0.72903);\n            transform: scaleY(0.72903); }\n  96% {\n    -webkit-transform: scaleY(0.78353);\n            transform: scaleY(0.78353); }\n  97% {\n    -webkit-transform: scaleY(0.83889);\n            transform: scaleY(0.83889); }\n  98% {\n    -webkit-transform: scaleY(0.89488);\n            transform: scaleY(0.89488); }\n  99% {\n    -webkit-transform: scaleY(0.95129);\n            transform: scaleY(0.95129); }\n  100% {\n    -webkit-transform: scaleY(1.0079);\n            transform: scaleY(1.0079); } }\n\n@keyframes squishBottom {\n  0% {\n    -webkit-transform: scaleY(1);\n            transform: scaleY(1); }\n  50% {\n    -webkit-transform: scaleY(1);\n            transform: scaleY(1); }\n  /* from π thru 2π */\n  51% {\n    -webkit-transform: scaleY(0.93947);\n            transform: scaleY(0.93947); }\n  52% {\n    -webkit-transform: scaleY(0.88313);\n            transform: scaleY(0.88313); }\n  53% {\n    -webkit-transform: scaleY(0.82725);\n            transform: scaleY(0.82725); }\n  54% {\n    -webkit-transform: scaleY(0.77205);\n            transform: scaleY(0.77205); }\n  55% {\n    -webkit-transform: scaleY(0.71776);\n            transform: scaleY(0.71776); }\n  56% {\n    -webkit-transform: scaleY(0.66458);\n            transform: scaleY(0.66458); }\n  57% {\n    -webkit-transform: scaleY(0.61273);\n            transform: scaleY(0.61273); }\n  58% {\n    -webkit-transform: scaleY(0.56241);\n            transform: scaleY(0.56241); }\n  59% {\n    -webkit-transform: scaleY(0.51383);\n            transform: scaleY(0.51383); }\n  60% {\n    -webkit-transform: scaleY(0.46717);\n            transform: scaleY(0.46717); }\n  61% {\n    -webkit-transform: scaleY(0.42261);\n            transform: scaleY(0.42261); }\n  62% {\n    -webkit-transform: scaleY(0.38035);\n            transform: scaleY(0.38035); }\n  63% {\n    -webkit-transform: scaleY(0.34053);\n            transform: scaleY(0.34053); }\n  64% {\n    -webkit-transform: scaleY(0.30333);\n            transform: scaleY(0.30333); }\n  65% {\n    -webkit-transform: scaleY(0.26888);\n            transform: scaleY(0.26888); }\n  66% {\n    -webkit-transform: scaleY(0.23732);\n            transform: scaleY(0.23732); }\n  67% {\n    -webkit-transform: scaleY(0.20879);\n            transform: scaleY(0.20879); }\n  68% {\n    -webkit-transform: scaleY(0.18338);\n            transform: scaleY(0.18338); }\n  69% {\n    -webkit-transform: scaleY(0.16121);\n            transform: scaleY(0.16121); }\n  70% {\n    -webkit-transform: scaleY(0.14236);\n            transform: scaleY(0.14236); }\n  71% {\n    -webkit-transform: scaleY(0.1269);\n            transform: scaleY(0.1269); }\n  72% {\n    -webkit-transform: scaleY(0.11489);\n            transform: scaleY(0.11489); }\n  73% {\n    -webkit-transform: scaleY(0.10639);\n            transform: scaleY(0.10639); }\n  74% {\n    -webkit-transform: scaleY(0.10143);\n            transform: scaleY(0.10143); }\n  75% {\n    -webkit-transform: scaleY(0.10002);\n            transform: scaleY(0.10002); }\n  76% {\n    -webkit-transform: scaleY(0.10217);\n            transform: scaleY(0.10217); }\n  77% {\n    -webkit-transform: scaleY(0.10788);\n            transform: scaleY(0.10788); }\n  78% {\n    -webkit-transform: scaleY(0.11712);\n            transform: scaleY(0.11712); }\n  79% {\n    -webkit-transform: scaleY(0.12985);\n            transform: scaleY(0.12985); }\n  80% {\n    -webkit-transform: scaleY(0.14602);\n            transform: scaleY(0.14602); }\n  81% {\n    -webkit-transform: scaleY(0.16558);\n            transform: scaleY(0.16558); }\n  82% {\n    -webkit-transform: scaleY(0.18843);\n            transform: scaleY(0.18843); }\n  83% {\n    -webkit-transform: scaleY(0.2145);\n            transform: scaleY(0.2145); }\n  84% {\n    -webkit-transform: scaleY(0.24368);\n            transform: scaleY(0.24368); }\n  85% {\n    -webkit-transform: scaleY(0.27585);\n            transform: scaleY(0.27585); }\n  86% {\n    -webkit-transform: scaleY(0.31089);\n            transform: scaleY(0.31089); }\n  87% {\n    -webkit-transform: scaleY(0.34865);\n            transform: scaleY(0.34865); }\n  88% {\n    -webkit-transform: scaleY(0.38899);\n            transform: scaleY(0.38899); }\n  89% {\n    -webkit-transform: scaleY(0.43175);\n            transform: scaleY(0.43175); }\n  90% {\n    -webkit-transform: scaleY(0.47676);\n            transform: scaleY(0.47676); }\n  91% {\n    -webkit-transform: scaleY(0.52384);\n            transform: scaleY(0.52384); }\n  92% {\n    -webkit-transform: scaleY(0.5728);\n            transform: scaleY(0.5728); }\n  93% {\n    -webkit-transform: scaleY(0.62346);\n            transform: scaleY(0.62346); }\n  94% {\n    -webkit-transform: scaleY(0.6756);\n            transform: scaleY(0.6756); }\n  95% {\n    -webkit-transform: scaleY(0.72903);\n            transform: scaleY(0.72903); }\n  96% {\n    -webkit-transform: scaleY(0.78353);\n            transform: scaleY(0.78353); }\n  97% {\n    -webkit-transform: scaleY(0.83889);\n            transform: scaleY(0.83889); }\n  98% {\n    -webkit-transform: scaleY(0.89488);\n            transform: scaleY(0.89488); }\n  99% {\n    -webkit-transform: scaleY(0.95129);\n            transform: scaleY(0.95129); }\n  100% {\n    -webkit-transform: scaleY(1.0079);\n            transform: scaleY(1.0079); } }\n\nmain {\n  flex: 1 1 25%;\n  background: #F5BF41;\n  font-family: 'Sometype Mono', sans-serif;\n  text-align: center;\n  overflow: auto; }\n\nsection {\n  padding: 10px; }\n\n@media screen and (max-aspect-ratio: 1 / 1) {\n  main {\n    flex-grow: 0;\n    flex-shrink: 0;\n    flex-basis: auto; } }\n\n@media screen and (min-aspect-ratio: 1 / 1) {\n  main {\n    display: flex;\n    flex-direction: column; } }\n\n/*\n\nrepeating-linear-gradient(45deg, rgba(255, 255, 255, 0.3) 0, rgba(255, 255, 255, 0.3) 1px, transparent 1px, transparent 8px), repeating-linear-gradient(-45deg, rgba(255, 255, 255, 0.3) 0, rgba(255, 255, 255, 0.3) 1px, transparent 1px, transparent 8px)\n\n*/\nbody.flames {\n  background: #ebede6;\n  /*\n    Top row will be warm hues\n  */\n  /*\n    Bottom row will be warm hues\n  */ }\n  body.flames .row:first-child .cell:nth-child(1) .letter svg path {\n    fill: #EF9124;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:last-child .cell:nth-child(1) .letter svg path {\n    fill: #74b6d0;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:first-child .cell:nth-child(2) .letter svg path {\n    fill: #d0b443;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:last-child .cell:nth-child(2) .letter svg path {\n    fill: #17a576;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:first-child .cell:nth-child(3) .letter svg path {\n    fill: #e5cad1;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:last-child .cell:nth-child(3) .letter svg path {\n    fill: #a5c69c;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:first-child .cell:nth-child(4) .letter svg path {\n    fill: #e29f8f;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:last-child .cell:nth-child(4) .letter svg path {\n    fill: #8493b1;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:first-child .cell:nth-child(5) .letter svg path {\n    fill: #BA4848;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:last-child .cell:nth-child(5) .letter svg path {\n    fill: #c9c7ed;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:first-child .cell:nth-child(6) .letter svg path {\n    fill: #EF9124;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:last-child .cell:nth-child(6) .letter svg path {\n    fill: #064bd3;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:first-child .cell:nth-child(7) .letter svg path {\n    fill: #d0b443;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:last-child .cell:nth-child(7) .letter svg path {\n    fill: #74b6d0;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:first-child .cell:nth-child(8) .letter svg path {\n    fill: #e5cad1;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:last-child .cell:nth-child(8) .letter svg path {\n    fill: #17a576;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:first-child .cell:nth-child(9) .letter svg path {\n    fill: #e29f8f;\n    stroke-width: 2px;\n    stroke: #333; }\n  body.flames .row:last-child .cell:nth-child(9) .letter svg path {\n    fill: #a5c69c;\n    stroke-width: 2px;\n    stroke: #333; }\n\nbody.red-and-blue main {\n  background: #c1b6fd;\n  color: #000da4; }\n\nbody.red-and-blue .grid {\n  background-color: #c9431f; }\n\nbody.red-and-blue .letter svg path {\n  fill: #c3c1e5;\n  stroke: #000da4; }\n\nbody.red-and-blue .letter svg path {\n  -webkit-animation-name: shimmerText;\n          animation-name: shimmerText;\n  -webkit-animation-duration: 5s;\n          animation-duration: 5s;\n  -webkit-animation-direction: alternate;\n          animation-direction: alternate;\n  -webkit-animation-iteration-count: infinite;\n          animation-iteration-count: infinite;\n  stroke-width: 0.6px; }\n\nbody.red-and-blue .cell:nth-child(1) .letter svg path {\n  -webkit-animation-delay: 1s;\n          animation-delay: 1s; }\n\nbody.red-and-blue .cell:nth-child(2) .letter svg path {\n  -webkit-animation-delay: 2s;\n          animation-delay: 2s; }\n\nbody.red-and-blue .cell:nth-child(3) .letter svg path {\n  -webkit-animation-delay: 3s;\n          animation-delay: 3s; }\n\nbody.red-and-blue .cell:nth-child(4) .letter svg path {\n  -webkit-animation-delay: 4s;\n          animation-delay: 4s; }\n\nbody.red-and-blue .cell:nth-child(5) .letter svg path {\n  -webkit-animation-delay: 5s;\n          animation-delay: 5s; }\n\nbody.red-and-blue .cell:nth-child(6) .letter svg path {\n  -webkit-animation-delay: 6s;\n          animation-delay: 6s; }\n\nbody.red-and-blue .cell:nth-child(7) .letter svg path {\n  -webkit-animation-delay: 7s;\n          animation-delay: 7s; }\n\nbody.red-and-blue .cell:nth-child(8) .letter svg path {\n  -webkit-animation-delay: 8s;\n          animation-delay: 8s; }\n\nbody.red-and-blue .cell:nth-child(9) .letter svg path {\n  -webkit-animation-delay: 9s;\n          animation-delay: 9s; }\n\nbody.red-and-blue .grid {\n  -webkit-animation-name: shimmerArtBackground;\n          animation-name: shimmerArtBackground;\n  -webkit-animation-duration: 5s;\n          animation-duration: 5s;\n  -webkit-animation-direction: alternate;\n          animation-direction: alternate;\n  -webkit-animation-iteration-count: infinite;\n          animation-iteration-count: infinite; }\n\n@-webkit-keyframes shimmerText {\n  0% {\n    fill: #c3c1e5; }\n  100% {\n    fill: #C1B5FF; } }\n\n@keyframes shimmerText {\n  0% {\n    fill: #c3c1e5; }\n  100% {\n    fill: #C1B5FF; } }\n\n@-webkit-keyframes shimmerArtBackground {\n  0% {\n    background-color: #c9431f; }\n  100% {\n    background-color: #BC4745; } }\n\n@keyframes shimmerArtBackground {\n  0% {\n    background-color: #c9431f; }\n  100% {\n    background-color: #BC4745; } }\n\nbody.inky-flames {\n  background: #C4CDCE; }\n  body.inky-flames .cell:nth-child(1) .letter svg path {\n    fill: #FD9900; }\n  body.inky-flames .cell:nth-child(2) .letter svg path {\n    fill: #F284C4; }\n  body.inky-flames .cell:nth-child(3) .letter svg path {\n    fill: #FBF5E2; }\n  body.inky-flames .cell:nth-child(4) .letter svg path {\n    fill: #FD4715; }\n  body.inky-flames .cell:nth-child(5) .letter svg path {\n    fill: #FD9900; }\n  body.inky-flames .cell:nth-child(6) .letter svg path {\n    fill: #F284C4; }\n  body.inky-flames .cell:nth-child(7) .letter svg path {\n    fill: #FBF5E2; }\n  body.inky-flames .cell:nth-child(8) .letter svg path {\n    fill: #FD4715; }\n  body.inky-flames .cell:nth-child(9) .letter svg path {\n    fill: #FD9900; }\n  body.inky-flames .cell .letter svg path {\n    stroke: blue;\n    stroke-width: 2px; }\n  body.inky-flames main {\n    background: blue;\n    color: white; }\n\nbody.boxed-text main {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-around; }\n\nbody.boxed-text p {\n  border-style: solid;\n  border-width: 3px 2px;\n  border-color: #333;\n  padding: 5px 10px;\n  font-family: 'Cantarell', sans-serif;\n  text-transform: uppercase;\n  flex: 1 1 auto;\n  order: 2;\n  display: flex;\n  flex-direction: column;\n  justify-content: center; }\n\nbody.boxed-text p.intro {\n  font-size: 21px;\n  font-weight: 700;\n  padding: 5px 25px;\n  flex: 2 1 auto;\n  order: 1; }\n\nbody.boxed-text p.link {\n  order: 3; }\n\nbody.boxed-text a,\nbody.boxed-text a:link,\nbody.boxed-text a:visited {\n  font-weight: 700;\n  text-decoration: underline;\n  color: black; }\n\nbody.boxed-text p:nth-of-type(1):hover {\n  background-color: #e29f8f; }\n\nbody.boxed-text p:nth-of-type(2):hover {\n  background-color: #a5c69c; }\n\nbody.boxed-text p:nth-of-type(3):hover {\n  background-color: #e5cad1; }\n\nbody.boxed-text p:nth-of-type(4):hover {\n  background-color: #c9c7ed; }\n\nbody.boxed-text p:nth-of-type(5):hover {\n  background-color: #74b6d0; }\n\nbody.boxed-text p:nth-of-type(6):hover {\n  background-color: #EF9124; }\n\nbody.left-right main {\n  padding: 20px;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-evenly; }\n\nbody.left-right a,\nbody.left-right a:link,\nbody.left-right a:visited {\n  color: black;\n  text-decoration: underline;\n  font-weight: 700; }\n\nbody.left-right p {\n  width: 75%;\n  font-family: 'Sometype Mono', monospace;\n  font-size: 20px; }\n\nbody.left-right p + p {\n  margin-top: 1em; }\n\nbody.left-right p:nth-child(odd) {\n  text-align: left;\n  margin-right: auto; }\n\nbody.left-right p:nth-child(even) {\n  text-align: right;\n  margin-left: auto; }\n\nbody.left-right p:first-child {\n  text-align: center;\n  width: 100%; }\n\nbody.left-right p.link {\n  border-style: solid;\n  border-color: #333;\n  border-width: 5px 3px;\n  text-transform: uppercase;\n  text-align: center;\n  width: 100%;\n  margin: 0;\n  padding: 10px 10px; }\n\nbody.left-right p.link a,\nbody.left-right p.link a:link,\nbody.left-right p.link a:visited {\n  text-decoration: none;\n  font-weight: normal; }\n\nbody.left-right section.footer {\n  margin: 10px;\n  border-style: solid;\n  border-color: black;\n  border-width: 4px 3px;\n  text-transform: uppercase;\n  padding: 5px; }\n", ""]);
...
/******/ });
//# sourceMappingURL=plur (candy flames + boxed text).js.map